...
//		TheaterDetails entity = showsRepository.save(theater);
//		if(entity != null) {
...
//		TheaterDetails entity = showsRepository.save(movie);
//		if(entity != null) {
//			return new MovieKey(entity.getId());
//		}
//		return null;
//	}
	...
	public List<ShowDetails> findByMovieNameAndCity(String movieName, String cityName) {
		// TODO Auto-generated method stub
		return showsRepository.findByMovieNameAndCity(movieName, cityName);
